...
export default function UserDropdown() {
  ...
  const handleSignOut = () => {
    // Clear session / auth tokens if any
    localStorage.clear(); // adjust if you have a different auth method
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm">Sunshine</span>
        <svg
